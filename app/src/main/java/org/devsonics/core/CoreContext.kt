...
import org.devsonics.BuildConfig
...
import org.devsonics.compatibility.PhoneStateInterface
import org.devsonics.contact.ContactLoader
import org.devsonics.contact.ContactsManager
import org.devsonics.contact.getContactForPhoneNumberOrAddress
import org.devsonics.notifications.NotificationsManager
import org.devsonics.telecom.TelecomHelper
...
//            notificationsManager.startForeground(service, useAutoStartDescription)
    ...
    private fun onIncomingReceived() {
        ...
        val intent = Intent(context, org.devsonics.activities.voip.CallActivity::class.java)
