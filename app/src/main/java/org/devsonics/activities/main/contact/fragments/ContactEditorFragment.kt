...
import org.devsonics.activities.main.contact.data.ContactEditorData
import org.devsonics.activities.main.contact.data.NumberOrAddressEditorData
import org.devsonics.activities.main.contact.viewmodels.*
import org.devsonics.activities.navigateToContact
import org.devsonics.databinding.ContactEditorFragmentBinding
...
class ContactEditorFragment : GenericFragment<ContactEditorFragmentBinding>(), SyncAccountPickerFragment.SyncAccountPickedListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (sipUri != null) {
            ...
            val newSipUri = NumberOrAddressEditorData("", true, data)
