 ...
 */
package org.devsonics.activities.main
...
import org.devsonics.activities.main.viewmodels.CallOverlayViewModel
import org.devsonics.activities.main.viewmodels.SharedMainViewModel
...
import org.devsonics.core.CorePreferences
import org.devsonics.databinding.MainActivityBinding
...
class MainActivity : GenericActivity(), SnackBarActivity, NavController.OnDestinationChangedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.sideMenu.setScrimColor(Color.TRANSPARENT)
        binding.sideMenu.drawerElevation = 0f
        ...
        when {
            ...
            intent.hasExtra("Dialer") -> {
                ...
                if (call != null) {
                    ...
                    val callIntent = Intent(this, org.devsonics.activities.voip.CallActivity::class.java)
