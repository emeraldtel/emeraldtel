...
import org.devsonics.activities.main.settings.viewmodels.SettingsViewModel
import org.devsonics.activities.navigateToAccountSettings
import org.devsonics.activities.navigateToAudioSettings
import org.devsonics.activities.navigateToTunnelSettings
import org.devsonics.activities.navigateToVideoSettings
import org.devsonics.databinding.SettingsFragmentBinding
...
class SettingsFragment : SecureFragment<SettingsFragmentBinding>() {
    ...
    override fun onDestroy() {
        super.onDestroy()
        sharedViewModel.isDestroyFragment.value = Event(true)
    }
}
